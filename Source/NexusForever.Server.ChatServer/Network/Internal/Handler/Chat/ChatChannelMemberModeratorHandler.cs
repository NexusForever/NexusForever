...
{
    public class ChatChannelMemberModeratorHandler : IHandleMessages<ChatChannelMemberModeratorMessage>
    {
        ...
        public ChatChannelMemberModeratorHandler(
        ...
        public async Task Handle(ChatChannelMemberModeratorMessage message)
        {
            ChatResult result = await SetModeratorAsync(message);
        ...
        private async Task<ChatResult> SetModeratorAsync(ChatChannelMemberModeratorMessage message)
        {
            ...
            return await channel.SetModeratorMemberAsync(message.Source.ToChatIdentity(), message.Target.ToChatIdentity(), message.Set);
        }
    }
}
