...
{
    public class FriendshipNameInviteRequestHandler : IHandleMessages<FriendshipNameInviteRequestMessage>
    {
        ...
        public FriendshipNameInviteRequestHandler(
        ...
        public async Task Handle(FriendshipNameInviteRequestMessage message)
        {
        ...
        private async Task<FriendshipResult?> InviteAsync(FriendshipNameInviteRequestMessage message)
        {
            ...
            if (string.IsNullOrWhiteSpace(message.InviteeName.RealmName))
            {
                inviteeIdentity = new IdentityName
                {
                    Name      = message.InviteeName.Name,
                    RealmName = inviter.IdentityName.RealmName
                };
            }
            else
                inviteeIdentity = message.InviteeName.ToFriendshipIdentity();
