...
namespace NexusForever.Server.Friendship
{
    ...
    {
        public static Identity ToFriendshipIdentity(this InternalIdentity identity)
        {
            return new Identity
            {
                Id      = identity.Id,
        ...
        public static IdentityName ToFriendshipIdentity(this InternalIdentityName identity)
        {
        ...
        public static APIdentityName ToAPIdentityName(this IdentityName identity)
        {
