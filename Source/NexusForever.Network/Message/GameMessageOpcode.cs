namespace NexusForever.Network.Message
{
    public enum GameMessageOpcode
    {
        ...
        ServerPlayerPathMissionAdvanced = 0x00F4,
        ServerPlayerPathExplorerPowerMapStarted = 0x00F5,
        ServerPlayerPathExplorerPowerMapEntered = 0x00F6,
        ServerPlayerPathExplorerPowerMapExited = 0x00F7,
        ServerPlayerPathExplorerPowerMapFailed = 0x00F8,
        ClientPlayerPathExplorerPowerMapProgress = 0x00F9,
        ServerPlayerPathExplorerPowerMapWaiting = 0x00FA,
        ...
        ServerPathExplorerChangeScavengerHuntClueWorldLocationId = 0x06B8,
        ServerPathExplorerAddUnitIdToScavengerHuntClue = 0x06B9,
