namespace NexusForever.Network.Message
{
    public enum GameMessageOpcode
    {
        ...
        ClientPlayerPathExplorerCastSearching = 0x0099,
        ...
        ClientPlayerPathScientistDimissScanbot1 = 0x00F0,
        ServerInstanceSettings          = 0x00F1, // handler sends 0x00D5 and ClientPlayerMovementSpeedUpdate
        ClientEnteredWorld              = 0x00F2,
        ClientPlayerPathExplorerProgress1 = 0x00F3,
        ServerOnPlayerPathMissionAdvanced = 0x00F4,
        ServerOnPlayerPathExplorerPowerMapStarted = 0x00F5,
        ServerOnPlayerPathExplorerPowerMapEntered = 0x00F6,
        ServerOnPlayerPathExplorerPowerMapExited = 0x00F7,
        ServerOnPlayerPathExplorerPowerMapFailed = 0x00F8,
        ClientPlayerPathExplorerProgress2 = 0x00F9,
        ServerOnPlayerPathExplorerPowerMapWaiting = 0x00FA,
        ...
        ClientPlayerPathScientistDimissScanbot2 = 0x015F,
        ClientPlayerPathScientistRequestScanbot = 0x0180,
        ServerPlayerPathUpdateXp        = 0x01AA,
        ...
        ServerInvokeScientistExperimentation = 0x667,
        ServerPlayerPathScientistScanbotState = 0x0669,
        ClientPathMissionAttempScientistExperimentation = 0x066A,
        ServerPlayerPathSettlerBuildResult = 0x066C,
        ServerPlayerPathInvokeSettlerBuild = 0x066D,
        ServerPlayerPathSettlerBuildStatusUpdate = 0x066E,
        ServerPlayerPathSettlerHubReward = 0x066F,
        ClientPlayerPathSettlerImprovementUnknown = 0x0670,
        ServerPlayerPathSettlerBuildStatusUpdate2 = 0x0671,
        ServerPlayerPathSettlerNotifyUse = 0x0672,
        ServerPlayerPathSettlerInfrastructureComplete = 0x0673,
        ServerPlayerPathSettlerInfrastructureUpdated = 0x0674,
        ServerPlayerPathSettlerInfrastructureStarted = 0x0675,
        ServerPlayerPathSoldierInvokeSoldierBuild = 0x0676,
        ServerPlayerPathInvokeScientistExperimentation = 0x0677,
        ServerPlayerPathUpdateSoldierBuild = 0x0678,
        ServerPlayerPathSoldierHoldOutNextWave = 0x679,
        ServerPlayerPathUpdateSoldierBuild1 = 0x067A,
        ServerPlayerPathSoldierHoldoutStatus = 0x067B,
        ServerPlayerPathSoldierHoldoutEnd = 0x067C,
        ClientPlayerPathSoldierImprovementUnknown = 0x067D,
        ServerPlayerPathSoldierNewWhackAMoleBurrows = 0x067E,
        ServerPlayerPathSoldierHoldoutDeath = 0x067F,
        ServerPlayerPathUpdateSoldierBuild2 = 0x0680,
        ServerPlayerPathUpdateSoldierBuild3 = 0x0681,
        ServerPendingWorldRemovalCancel = 0x0688,
        ServerPendingWorldRemoval       = 0x0689,
        Server068B                      = 0x068B, // pet customization something
        ClientPlayerPathLib_SetScannerName = 0x068C,
        ServerUnlockPetFlair            = 0x068D,
        ServerChangePetStance           = 0x068F,
        ClientRequestPlayed             = 0x0693,
        ServerPlayerPlayed              = 0x0694,
        ClientPlayerPathChange          = 0x06B2,
        ServerPlayerPathChangeResult    = 0x06B3,
        ServerPlayerPathRefresh         = 0x06B4,
        ServerPlayerPathEpisodeProgress = 0x06B5,
        ServerPlayerPath06B6            = 0x06B6,
        ServerPlayerPath06B7            = 0x06B7,
        ServerPlayerPath06B8            = 0x06B8,
        ServerPlayerPath06B9            = 0x06B9,
        ServerPlayerPathMissionActivate = 0x06BA, 
        ServerPlayerPathMissionUpdate   = 0x06BB,
        ServerPlayerPathReinitialize    = 0x06BC,
        ClientPlayerPathUnlock          = 0x06BD,
        ServerPlayerPathUnlockResult    = 0x06BE,
        ServerPlayerPathCurrentEpisode  = 0x06BF,
        ...
        ServerPathScientistAddCreatureInfoToCreatureSet = 0x08B2,
        ServerConfirmUnit               = 0x08B3,
        ServerPathScientistAddSpecimenSurveyToCreatureSet = 0x08B4,
        ServerPathScientistAddFieldStudyToCreatureSet = 0x08B5,
        ServerPlayerPathSettlerRelated  = 0x08B6,
        ServerPlayerPathSettlerHubUpdate = 0x08B7,
