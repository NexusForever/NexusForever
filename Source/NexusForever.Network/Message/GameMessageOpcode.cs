namespace NexusForever.Network.Message
{
    public enum GameMessageOpcode
    {
        ...
        ServerUnitAppearance            = 0x08A8,
        ServerUnitMinimapMarkerHidden   = 0x08AC,
        ...
        ServerUnitClusterMembership     = 0x0932,
        ServerItemVisualUpdate          = 0x0933,
        ServerEntityFaction             = 0x0934,
        ServerEntityStatUpdateFloat     = 0x0935,
        ServerUnitGroupChanged          = 0x0936,    
        ServerEntityHealthUpdate        = 0x0937,
        ServerEntityStatUpdateInteger   = 0x0938,
        ServerUnitNameAndTitleChange    = 0x0939,
        ServerEntityPropertiesUpdate    = 0x093A,
        ServerUnitUpdateObjectiveIndex  = 0x093B,
        ServerEmoteAndStandState        = 0x093C,
        ServerUnitPropertyUnknownUpdate = 0x093D,
        ServerUnitTagOwner              = 0x093E,
        ServerRefreshHealthCeiling      = 0x093F,
        ServerRefreshHealthFloor        = 0x0940,
