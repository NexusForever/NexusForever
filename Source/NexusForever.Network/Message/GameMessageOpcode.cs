namespace NexusForever.Network.Message
{
    public enum GameMessageOpcode
    {
        ...
        ServerPTPTradeUpdate1           = 0x018E,
        ClientP2PTradingCancelTrade     = 0x018F,
        ClientP2PTradingCommitUnCommit  = 0x0190,
        ClientP2PTradingDeclineInvite   = 0x0191,
        ClientP2PTradingInitiateTrade   = 0x0192,
        ServerPTPTradeInvite            = 0x0193,
        ClientP2PTradingRemoveItem      = 0x0194,
        ServerPTPTradeChange            = 0x0195,
        ServerPTPTradeResult            = 0x0196,
        ClientP2PTradingRemoveItem2     = 0x0197,
        ServerP2PTradeChange2           = 0x0198,
