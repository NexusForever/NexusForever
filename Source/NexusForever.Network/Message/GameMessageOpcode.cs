namespace NexusForever.Network.Message
{
    public enum GameMessageOpcode
    {
        ...
        ServerMissileActorAdd           = 0x025F,
        ServerMissileActorListAdd       = 0x0260,
        ...
        ServerMissileActorRemove        = 0x077D,
        ...
        ServerSpellGo                   = 0x07F4, // execute spells cast by the player
        ServerSpellEffectExecute        = 0x07F5,
        ServerSpellReflect              = 0x07F6,
        ServerSpellEffectRemove         = 0x07F7,
        ServerSpellEffectResultAnnounce = 0x07F8,
        ServerSpellInterrupted1         = 0x07F9, // possible this is only for cancelling casts from player
        ServerSpellInterrupted2         = 0x07FA, // possible this is only for cancelling casts from other units
        ServerSpellRemove               = 0x07FB,
        ServerSpellCastResult           = 0x07FC,
        ServerSpellConfirmCast          = 0x07FD,
        ServerSpellFinish               = 0x07FE,
        ServerSpellStart                = 0x07FF, 
        ClientSpellStopCast             = 0x0801,
        ClientCancelEffect              = 0x0802,
        ServerSpellCooldownStart        = 0x0804,
        ClientSpellClientSideInteraction = 0x0805,
        ServerSpellDisableCooldowns     = 0x080E,
        ServerSpellBuffsAdd             = 0x080F,
        ...
        ServerSpellExecute              = 0x0818, // executes spells cast by others 
        ServerSpellAuraCancel           = 0x0819,
        ...
        ClientStuck                     = 0x0831,
        ServerAnnounceCommandOnCooldown = 0x0832,
