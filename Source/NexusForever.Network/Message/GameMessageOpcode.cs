namespace NexusForever.Network.Message
{
    public enum GameMessageOpcode
    {
        ...
        ClientAbilityBook_ActivateSpell = 0x017A,
        ...
        ServerSpellEffectResultAnnounce = 0x7F8,
        ServerSpellInterrupted1         = 0x7F9, // possible this is only for cancelling casts from player
        ServerSpellInterrupted2         = 0x7FA, // possible this is only for cancelling casts from other units
        ServerSpellRemove               = 0x7FB,
        ...
        ClientSpellClientSideInteraction = 0x805,
        ServerSpellDisableCooldowns     = 0x80E,
        ServerSpellBuffsAdd             = 0x80F,
        ServerSpellBuffsUpdate          = 0x810,
        ServerSpellBuffRemove           = 0x811,
        ServerSpellUpdateEffectDuration = 0x812,
        ServerSpellRemoveOneStackOfBuff = 0x813,
        ServerSpellThresholdClear       = 0x814,
        ServerSpellThresholdCancel      = 0x815,
