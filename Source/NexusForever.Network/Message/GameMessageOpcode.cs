namespace NexusForever.Network.Message
{
    public enum GameMessageOpcode
    {
        ...
        ClientGameCommandPrimaryPetBar  = 0x0073,
        ...
        ClientActionSetNonSpellChanges  = 0x016A,
        ServerActionBarSetDynamic       = 0x016B,
        ServerActionBarSet              = 0x016C,
        ServerAbilityTierPointsBonus    = 0x016E,
        ...
        ClientGameCommandPetBarMini     = 0x068A,
