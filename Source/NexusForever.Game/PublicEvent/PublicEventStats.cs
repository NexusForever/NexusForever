...
namespace NexusForever.Game.PublicEvent
{
    ...
    {
        public static readonly Dictionary<PublicEventStat,uint> StatToBitDictionary = new Dictionary<PublicEventStat,uint>()
        {
        ...
        public NetworkPublicEventStats Build()
        {
            ...
            {
                uint bitNumber = PublicEventStats.StatToBitDictionary[stat];
            ...
            {
                uint bitNumber = PublicEventStats.StatToBitDictionary[(PublicEventStat)((uint)Static.PublicEvent.PublicEventStat.CustomStat00 + index)];
