...
namespace NexusForever.Game.TextFilter
{
    public class TextFilterLanguage
    {
        ...
        /// <summary>
        /// Create a new <see cref="TextFilterLanguage"/> class with the specified <see cref="Static.Language"/> and collection of <see cref="WordFilterEntry"/>'s.
        /// </summary>
