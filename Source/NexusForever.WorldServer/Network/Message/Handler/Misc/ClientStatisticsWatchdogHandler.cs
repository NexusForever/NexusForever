...
{
    public class ClientStatisticsWatchdogHandler : IMessageHandler<IWorldSession, ClientStatisticsWatchdog>
    {
        /// <summary>
        ...
        /// </summary>
        public void HandleMessage(IWorldSession session, ClientStatisticsWatchdog watchdogStatistics)
        {
        }
    }
}
