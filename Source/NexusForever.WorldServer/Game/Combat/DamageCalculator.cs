...
namespace NexusForever.WorldServer.Game.Combat
{
    public sealed class DamageCalculator : Singleton<DamageCalculator>
    {
        ...
        /// </summary>
        public uint GetBaseDamageForSpell(IUnitEntity attacker, float parameterType, float parameterValue)
        {
        ...
        {
            uint maxShieldAmount = (uint)(damage * victim.GetPropertyValue(Property.ShieldMitigationMax)); // TODO: This was updated, check if it was correct
