...
INSERT IGNORE INTO `entity_stats`(id,stat,type,value) SELECT `id`,  0, 0, 1000 FROM `entity`;
INSERT IGNORE INTO `entity_stats`(id,stat,type,value) SELECT `id`, 10, 0, 15 FROM `entity`;
